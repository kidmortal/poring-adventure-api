...
INSERT INTO "new_Skill" ("attribute", "category", "effect", "id", "image", "manaCost", "multiplier", "name", "professionId", "requiredLevel") SELECT "attribute", "category", "effect", "id", "image", "manaCost", "multiplier", "name", "professionId", "requiredLevel" FROM "Skill";
DROP TABLE "Skill";
